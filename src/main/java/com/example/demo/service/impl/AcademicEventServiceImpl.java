...
public class AcademicEventServiceImpl implements AcademicEventService {
    ...
    public AcademicEvent createEvent(AcademicEvent event) {
        if (event.getStartDate().isAfter(event.getEndDate())) throw new ValidationException("Start date cannot be after end date");
    ...
    public AcademicEvent updateEvent(Long id, AcademicEvent eventDetails) {
        ...
        if (eventDetails.getStartDate().isAfter(eventDetails.getEndDate())) throw new ValidationException("Invalid dates");
