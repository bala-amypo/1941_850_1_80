...
public class HarmonizedCalendarController {
    ...
    public HarmonizedCalendar generateCalendar(@RequestBody Map<String, String> payload) {
        return service.generateHarmonizedCalendar(payload.get("title"), payload.get("generatedBy"));
    }
    ...
    @GetMapping("/range")
    public List<HarmonizedCalendar> getCalendarsRange(@RequestParam LocalDate start, @RequestParam LocalDate end) {
